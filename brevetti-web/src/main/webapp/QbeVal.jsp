	        ...
	        <table width="100%" border="0" cellpadding="0" cellspacing="0">
	          ...
	          <tr> 
                ...
                <table width="96%" border="0" cellpadding="5">
                  ...
                  <tr>
                    <td align="right">Azienda:</td>
                    <td width="42%" align="left"><html:select property="aziendaId" style="font-family: Arial, Helvetica, sans-serif; font-size: 11px;width: 350px;">

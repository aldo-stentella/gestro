  ...
  <table width="100%" class="pagetable">
    ...
    <tr>
      ...
      <td width="100%" class="pagetable">
        <div class="titolo"><!-- InstanceBeginEditable name="title" -->&nbsp;<!-- InstanceEndEditable --></div><br/>
        <!-- InstanceBeginEditable name="content" --> &nbsp;
        <table width='100%' border='0' cellpadding='0' cellspacing='0'>
        <tr id='tabs'><td id='tabon'>&nbsp;</td></tr></table>
        <table width="100%" border="0" cellpadding="5" id="area">
          <tr>
            <td height="121" align="center" valign="bottom"><img src="images/working.gif" width="26" height="36" /><br />
              <br />
                <span class="errorMsg">Funzionalit&agrave; in corso di realizzazione...<br />
            &nbsp;</span></td>
          </tr>
          <tr> 
            <td align="center" valign="top"><input type="button" value="Chiudi" onclick="window.location='home.do';" /></td>
          </tr>
        </table>
        <!-- InstanceEndEditable -->
        </td>

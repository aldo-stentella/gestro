        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="center" valign="top" id="area"> 
              <table width="100%" border="0" cellpadding="10">
                <tr> 
                  <td height="42" align="right" valign="top">NsRif </td>
                  <td align="left" valign="top"><input name="" type="text" readonly="true" value="<%= trovato.getNsrif() %>"/>
                    &nbsp;</td>
                </tr>
                <tr>
                  <td height="101" align="right" valign="top">Titolo</td>
                  <td align="left" valign="top"><textarea name="textarea" cols="50" rows="6" readonly="true"><%= trovato.getTitolo() %></textarea></td>
                </tr>
              </table><br />
            Trovato scritto con successo.</td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center">
    	        ...
    	        &nbsp;&nbsp; 
	            <input type="button" value="Ultima ricerca" onclick="window.location='GesTro.do?lastQBE=y';" />
            </td>
          </tr>
        </table>
        <!-- InstanceEndEditable -->

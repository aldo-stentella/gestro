  ...
  <table width="100%" class="pagetable">
    ...
    <tr>
      ...
      <td width="100%" class="pagetable">
        <div class="titolo"><!-- InstanceBeginEditable name="title" -->Motore di ricerca trovati<!-- InstanceEndEditable --></div><br/>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td id="area">
               	   ...
               	   <form name="form" method="post" action="Tuning.do">
         <table align="center">
      <tr>
        <td>&nbsp;</td>
        <td colspan="2">&nbsp;</td>
      ...
      <tr>
        <td>Parole chiave:</td>
        <td colspan="2"><input name="keywords" type="text" size="60" /></td>
      </tr>

      <tr>
        <td valign="top">&nbsp;</td>
        <td colspan="2"><input type="button" value="Ricerca" onclick="doSubmit();" /></td>
      </tr>
    </table>
    </form>

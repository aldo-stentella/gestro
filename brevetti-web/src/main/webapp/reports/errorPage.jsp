...
<div class="center">
  <table width="901" align="center" class="pagetable">
    <tr>
      <td id="header" align="left"><img src="images/catalogo_banner.png" width="900" height="100" border="0" /></td>
    </tr>
    <tr>
      <td width="900" class="pagetable">
        ...
        <br/>
        <br />
        Al momento non &egrave; possibile accedere ai dati del catalogo. <br/>
        <br />
        <br/>

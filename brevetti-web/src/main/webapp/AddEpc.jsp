...
function infoTit(riga, idc, tipo){
	if(tipo == 3){
		...
		alert('"'+ document.forms[0].elements[riga * 3 + 22].value + '"');
	} else if(tipo == 4) {
		if(idc!=null ){
...
<html:form action="InsEpc.do" method="POST">
...
<tr>
        ...
        <td align="left"><img src="images/eu.gif" /><span class="wide"> EPC</span></td>
        <td rowspan="2" align="right"><strong>Pubblicazione europea: </strong></td>
        <td align="right">N&deg;</td>
        <td align="left"><html:text property="numPubblicazione" size="23" /></td>
</tr>
<tr>
  <td width="112" rowspan="4" align="center"><strong>Deposito europeo: </strong></td>
  <td align="center">Priorit&agrave;</td>
  <td align="left"><html:radio property="primo" value="1"/>S&igrave; &nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr>
    ...
    <td width="213" align="left"><html:text property="numeroDeposito" size="23" />&nbsp; <c:if test="${sessionScope.amministraTrovati}"><img src="images/attach1.gif" width="25" height="25" alt="Documenti allegati" class="imaction" onclick="openDocs(<c:out value="${datiTrovato.nsrif}" />, <c:out value="${not empty datiDepEst.id ? datiDepEst.id : -1}" />, 5);" /></c:if></td>
    <td width="122" rowspan="3" align="right"><strong>Rilascio:</strong></td>
    <td width="51" align="right">&nbsp;</td>
    <td width="207" align="left">&nbsp;</td>
  </tr>
  <tr>
    <td align="right">data effettiva</td>
    ...
    <td align="right">N&deg;</td>
    <td align="left"><html:text property="numRilascioDep" size="23" />&nbsp; <c:if test="${sessionScope.amministraTrovati}"><img src="images/attach1.gif" width="25" height="25" alt="Documenti allegati" class="imaction" onclick="openDocs(<c:out value="${datiTrovato.nsrif}" />, <c:out value="${not empty datiDepEst.id ? datiDepEst.id : -1}" />, 4);" /></c:if></td>
  </tr>
  <tr>
    <td align="right">data ufficiale</td>
    ...
    <td align="left"><html:text property="dataRilascioDepX" size="10" />
      <img src="images/cal04c.gif" alt="" align="top" class="imaction" onclick="showCal('dataRilascio');" /> </td>
  </tr>
  <tr>
    <td rowspan="2" align="center" valign="middle"><strong>Estinzione titolarit&agrave;:</strong></td>
    <td align="right">data</td>
    <td align="left"><html:text property="dataAbbandonoX" size="10" />
      <img src="images/cal04c.gif" alt="" align="top" class="imaction" onclick="showCal('dataAbbandono');" /></td>

...
public class SelTitolare extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if (request.getMethod().equals("POST")) {
			...
			if(mapTit==null) {
				mapTit = new HashMap<Integer, Titolarita>();
			...
			//tit.setPercentuale(mapTit.get(titolaritaId).getPercentuale());
